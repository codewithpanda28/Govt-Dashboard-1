          ...
          <div className="lg:col-span-1 space-y-6">
              ...
              <CardContent className="pt-6">
                <div className="text-center">
                  {accused.photo_url ? (
                    ...
                    <div className="w-48 h-48 rounded-lg bg-gray-100 flex items-center justify-center mx-auto border-4 border-gray-200">
            ...
            <Card>
              <CardContent className="pt-6 space-y-2">
                <Button className="w-full" onClick={() => router.push(`/accused/edit/${accused.id}`)}>
                ...
                <CardContent className="pt-6">
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">{fir.fir_number}</p>
                    </div>
                    <div>
                      <label className="text-sm text-gray-500">Incident Date</label>
                      <p className="font-medium text-gray-900">
                        {formatDate(fir.incident_date)} at {fir.incident_time}
                      </p>
                    </div>
                    <div className="sm:col-span-2">
                      <label className="text-sm text-gray-500">Description</label>
                      <p className="font-medium text-gray-900">{fir.brief_description}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  {accused.date_of_birth && (
                    <div>
                      ...
                      <p className="font-medium text-gray-900">
                        {formatDate(accused.date_of_birth)}
                      </p>
                    </div>
                  )}
                  {accused.father_name && (
                    <div>
                      ...
                      <p className="font-medium text-gray-900">{accused.father_name}</p>
                    </div>
                  )}
                  {accused.mother_name && (
                    <div>
                      <label className="text-sm text-gray-500">Mother's Name</label>
                      <p className="font-medium text-gray-900">{accused.mother_name}</p>
                    </div>
                  )}
                </div>
              </CardContent>
              ...
              <CardContent className="pt-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="font-medium text-gray-900">{accused.current_address}</p>
                  </div>
                  {accused.permanent_address && accused.permanent_address !== accused.current_address && (
                    <div>
                      <label className="text-sm text-gray-500">Permanent Address</label>
                      <p className="font-medium text-gray-900">{accused.permanent_address}</p>
                    </div>
                  )}
                </div>
              </CardContent>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  {accused.aadhar_number && (
                    <div>
                      ...
                      <p className="font-medium text-gray-900">{accused.aadhar_number}</p>
                    </div>
                  )}
                  {accused.pan_number && (
                    <div>
                      <label className="text-sm text-gray-500">PAN Number</label>
                      <p className="font-medium text-gray-900">{accused.pan_number}</p>
                    </div>
                  )}
              ...
              <CardContent className="pt-6">
                <div className="grid gap-4 sm:grid-cols-3">
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <p className="text-2xl font-bold text-gray-900">{accused.previous_cases || 0}</p>
                    <p className="text-sm text-gray-500 mt-1">Previous Cases</p>
                  </div>
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <p className="text-2xl font-bold text-gray-900">{accused.previous_convictions || 0}</p>
