          ...
          <div className="mb-8">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-64">
                <DropdownMenuItem>📩 New FIR Assigned</DropdownMenuItem>
                <DropdownMenuItem>✅ Bail Approved</DropdownMenuItem>
                <DropdownMenuItem>⚠️ Court Date Tomorrow</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
